namespace Paintball.Web.Constants
{
    public static class ContentDeliveryNetwork
    {
        ...
        public static class Cdnjs
        {
            public const string Domain = "cdnjs.cloudflare.com";
            public const string Headroom = "//cdnjs.cloudflare.com/ajax/libs/headroom/0.9.3/headroom.min.js";
            public const string HeadroomJQuery = "//cdnjs.cloudflare.com/ajax/libs/headroom/0.9.3/jQuery.headroom.min.js";
        }

        public static class FontGoogle
        {
            public const string Domain = "fonts.googleapis.com";
        }

        public static class GStatic
        {
            public const string Domain = "*.gstatic.com";
        }
