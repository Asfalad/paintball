...
namespace WebApiTesting.Controllers
{
    ...
    public class AccountApiController : ApiController
    {
        ...
        {
            IdentityUser user = await UserManager.FindByIdAsync(Guid.Parse(User.Identity.GetUserId()));
            ...
            foreach (IdentityLogin linkedAccount in user.Logins)
            {
        ...
        // POST papi/account/ChangePassword
        ...
        // POST papi/account/AddExternalLogin
        ...
        // GET papi/account/ExternalLogin
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = PaintballOAuthProvider.CreateProperties(user);
        ...
        // GET papi/account/ExternalLogins?returnUrl=%2F&generateState=true
        [AllowAnonymous]
        ...
        // POST papi/account/RegisterExternal
        [OverrideAuthentication]
        [HostAuthentication(DefaultAuthenticationTypes.ExternalBearer)]
