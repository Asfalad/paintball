            ...
            filters.Add(
                new CspFontSrcAttribute()
                {
                    ...
                    CustomSources = string.Join(
                        ...
                        ContentDeliveryNetwork.FontGoogle.Domain,
                        ContentDeliveryNetwork.GStatic.Domain),
...
#if DEBUG
                    // Allow Browser Link to work in debug mode only.
                    CustomSources = "data: " + ContentDeliveryNetwork.Google.Domain + " " + 
                    ContentDeliveryNetwork.GStatic.Domain,
#else
            ...
            filters.Add(
                new CspScriptSrcAttribute()
                {
                    ...
                    CustomSources = string.Join(
                        ...
                        ContentDeliveryNetwork.Cdnjs.Domain),
